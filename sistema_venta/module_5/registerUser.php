        ...
        if($nic != ""){
          if($pass != "" && $cpass != ""){
            if($pass == $cpass){
                ...
                $sqli = "Insert Into user(Full_Name,NIC_Number,Email,Password,email_verifyed,Token) VALUES ('$fullName','$nic','$email','$enc_pass',0,'$token')";
...
echo "<script>window.location = '/sistema_venta/module_5/usuarios.php'; </script>";